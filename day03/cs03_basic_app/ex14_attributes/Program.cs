...
namespace ex14_attributes
{
    class MyClass
    {
        // 버전업을 하다보면 더 이상 못 쓰는 메써드들이 있기 때문에 잠시 놔뒀다가 다음 버전에선 못 쓰게 함.. 중간단계에서 Obsolete를 쓰는거겠지 그럼?
        [Obsolete("이 메서드는 다음 버전에서 폐기됩니다. NewMethod()를 사용하세요.", false)]   // true는 OldMethod() 아예 사용불가
        /// <summary>
        /// 올드메써드. 이렇게 쓰셈!
        /// </summary>
